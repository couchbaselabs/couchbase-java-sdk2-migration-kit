...
import com.couchbase.client.core.deps.com.fasterxml.jackson.core.io.JsonStringEncoder;
...
public class JsonFunctions {
    ...
    public static Expression decodeJson(String jsonString) {
        try {
            JsonObject jsonObject = JacksonTransformers.MAPPER.readValue(jsonString, JsonObject.class);
