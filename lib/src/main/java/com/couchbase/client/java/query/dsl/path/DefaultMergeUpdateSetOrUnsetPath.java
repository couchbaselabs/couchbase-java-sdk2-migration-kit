...
public class DefaultMergeUpdateSetOrUnsetPath extends DefaultMergeUpdateWherePath implements MergeUpdateSetOrUnsetPath {

  private static final SetElement.SetPosition POS = SetElement.SetPosition.INITIAL;

  public DefaultMergeUpdateSetOrUnsetPath(AbstractPath parent) {
    super(parent);
  }
